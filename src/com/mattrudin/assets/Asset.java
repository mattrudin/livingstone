...
public class Asset {
    ...
    /**
     * Will build a new Asset with the given values.
     *
     * @param date
     * @param open
     * @param last
     ...
     * @param volume
     */
    public Asset(LocalDate date, BigDecimal open, BigDecimal last, BigDecimal high, BigDecimal low, BigDecimal volume) {
        this.date = date;
        this.open = open;
        this.last = last;
        this.high = high;
    ...
    /**
     * Will convert a String to an Asset. The String must comply the following convention:
     * DATE, OPEN, HIGH, LOW, LAST, MID, VOLUME
     * Please not the delimiter ",".
     *
     * @param line
     */
    public Asset(final String line) {
        ...
        new Asset(date, open, high, low, last, volume);
    }
