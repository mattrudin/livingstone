...
public interface IFinanceService {
  ...
  /**
   * Will return an Asset on daily basis to the given symbol. Starting from the given date till
   * today.
   *
   * @param symbolName
   * @param from
   ...
   * @return
   */
  List<Asset> getPrices(
      final List<String> symbolNames, final LocalDate from, final LocalDate until);

  /**
   * Will return a map of Assets on daily basis to the given symbols. Starting from the given date
   * till today.
   *
   * @param symbolNames
   * @param from
