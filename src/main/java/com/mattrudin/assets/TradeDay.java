...
public class TradeDay {
     ...
     * @param volume
     */
    public TradeDay(LocalDate date, BigDecimal open, BigDecimal last, BigDecimal high, BigDecimal low, BigDecimal adjustedClose, BigDecimal volume) {
        this.date = date;
        this.open = open;
        this.last = last;
        this.high = high;
     ...
     * DATE, OPEN, HIGH, LOW, LAST, ADJ_CLOSE, VOLUME
